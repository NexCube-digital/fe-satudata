...
export const CTASection: React.FC = () => {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-teal-800/40 bg-gradient-to-r from-teal-900 via-teal-800 to-cyan-950 px-6 py-12 text-white shadow-xl sm:px-10 lg:px-14 lg:py-16 reveal-scale">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto space-y-5">
        <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/10 border border-white/20 text-white backdrop-blur-md shadow-xs">
          <Activity className="h-6 w-6 animate-pulse text-teal-300" />
        </span>
        ...
        <p className="max-w-2xl text-xs sm:text-sm leading-relaxed text-teal-100/90 font-medium">
        ...
        <div className="flex flex-col gap-3.5 sm:flex-row pt-3">
          <Link
            href="/auth/register"
            className="inline-flex items-center justify-center gap-2.5 rounded-2xl bg-white px-7 py-3.5 text-xs font-extrabold text-teal-950 shadow-md transition-all duration-200 hover:bg-teal-50 hover:scale-[1.02]"
          >
            <Building className="h-4 w-4 text-teal-800" />
