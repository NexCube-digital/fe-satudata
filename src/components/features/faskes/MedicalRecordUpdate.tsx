...
export interface MedicalRecordUpdateActionsProps {
  isFirstStep: boolean;
...
export default function MedicalRecordUpdateActions({
  ...
  onSaveDraft,
  onFinalSubmit,
}: MedicalRecordUpdateActionsProps) {
  ...
  return (
    <div className="mt-8 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
      <button
        ...
        className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-bold text-slate-600 hover:bg-slate-50 transition disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
      >
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        ...
        {isLastContentStep ? (
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-teal-700 to-cyan-800 px-5 py-3 text-sm font-bold text-white hover:from-teal-800 hover:to-cyan-900 transition disabled:opacity-50 cursor-pointer shadow-xs"
          >
