    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6 text-xs max-h-[80vh] overflow-y-auto">
          {errorMsg && (
            <div className="p-3.5 rounded-2xl bg-rose-50 border border-rose-200 text-rose-700 font-semibold flex items-center gap-2 animate-fade-in">
          ...
          <div className="space-y-4 bg-slate-50/60 p-5 rounded-2xl border border-slate-200/80">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 text-xs text-slate-900 font-mono font-bold focus:border-teal-600 outline-hidden"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 text-xs text-slate-900 font-medium focus:border-teal-600 outline-hidden"
                />
              </div>
              <div>
                <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 text-xs text-slate-900 font-medium focus:border-teal-600 outline-hidden cursor-pointer"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-1">
                  Alamat Domisili KTP <span className="text-rose-500">*</span>
                </label>
                <input
                  type="text"
                  required
