...
export const LandingFooter: React.FC = () => {
  return (
    <footer className="border-t border-teal-100 bg-gradient-to-b from-slate-50 to-slate-100/80 pt-16 pb-10 text-xs text-slate-500">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-5 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5 font-medium">
              <li>
                <Link href="/login" className="hover:text-teal-800 transition">Masuk Portal (Login)</Link>
              </li>
              <li>
