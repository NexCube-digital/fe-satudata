      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {capabilities.map((item) => {
          ...
          return (
            <article
              key={item.title}
              className="group relative rounded-3xl border border-slate-200/80 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-teal-300 hover:shadow-xl hover:shadow-teal-950/5 flex flex-col justify-between reveal-scale"
            >
              {/* Top Glow Accent */}
