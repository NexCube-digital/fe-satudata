  ...
  return (
    <section id="faq" className="glass-panel rounded-3xl border border-slate-200/80 bg-white px-6 py-10 shadow-sm sm:px-10 lg:px-14 lg:py-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 pb-6 border-b border-slate-100">
        ...
        <Link
          href="/faq"
          className="inline-flex items-center gap-2 rounded-2xl bg-teal-50 border border-teal-200 px-5 py-2.5 text-xs font-extrabold text-teal-900 hover:bg-teal-100 transition shrink-0 self-start md:self-auto"
        >
            ...
            >
              ...
              >
                <span className="text-xs sm:text-sm font-extrabold text-slate-900 flex items-center gap-3">
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-teal-100 text-teal-800 text-[10px] font-mono">
                    0{index + 1}
                  </span>
                  {faq.question}
                </span>
              ...
              {isOpen && (
                <div className="px-4 pb-5 pt-0 sm:px-5 sm:pb-5 text-xs leading-relaxed text-slate-600 border-t border-teal-100/60 mt-1 pt-3 animate-in fade-in duration-200">
                  <p>{faq.answer}</p>
                </div>
              )}
            </div>
