...
export default function FAQPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f8fafc] via-[#f1f5f9] to-[#e2e8f0] flex flex-col pt-16 sm:pt-20">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 w-full space-y-10">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-teal-800/40 bg-gradient-to-r from-teal-900 via-teal-800 to-cyan-950 p-8 sm:p-12 text-white shadow-xl">
          <div className="pointer-events-none absolute -right-20 -top-20 h-80 w-80 rounded-full bg-teal-500/10 blur-[80px]" />

          <div className="relative z-10 max-w-3xl mx-auto text-center space-y-4">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1 text-xs font-semibold text-teal-200">
              ...
              <button
                ...
                className={`flex items-center gap-2 rounded-2xl px-4 py-2.5 text-xs font-extrabold transition cursor-pointer whitespace-nowrap ${
                  isActive
                    ...
                    : "bg-white border border-slate-200/80 text-slate-600 hover:bg-teal-50 hover:text-teal-900"
                }`}
              >
          ...
          {filteredFaqs.length === 0 ? (
            <div className="rounded-3xl border border-slate-200/80 bg-white p-12 text-center space-y-3">
              ...
              <button
                ...
                className="mt-2 inline-flex items-center gap-1.5 rounded-xl bg-teal-50 border border-teal-200 px-4 py-2 text-xs font-bold text-teal-800"
              >
                Reset Pencarian
              </button>
            </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <span className="rounded-lg bg-teal-50 text-teal-800 border border-teal-100 px-2 py-0.5 text-[10px] font-bold">
                          {faq.categoryLabel}
                        </span>
        ...
        <div className="pt-6 border-t border-slate-200/80">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-2xs hover:shadow-md transition space-y-3">
              <div className="h-10 w-10 rounded-xl bg-teal-50 text-teal-800 flex items-center justify-center border border-teal-100">
              ...
              <a href="mailto:support@satudata.id" className="inline-flex items-center gap-1.5 text-xs font-bold text-teal-800 hover:underline">
            ...
            <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-2xs hover:shadow-md transition space-y-3">
              ...
              <Link href="/dashboard/faskes" className="inline-flex items-center gap-1.5 text-xs font-bold text-[#16A34A] hover:underline">
            ...
            <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-2xs hover:shadow-md transition space-y-3 sm:col-span-2 lg:col-span-1">
              <div className="h-10 w-10 rounded-xl bg-sky-50 text-[#0284C7] flex items-center justify-center border border-sky-100">
              ...
              <Link href="/dashboard/pasien" className="inline-flex items-center gap-1.5 text-xs font-bold text-[#0284C7] hover:underline">
