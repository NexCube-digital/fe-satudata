...
export default function CTASection() {
  return (
    <section className="relative overflow-hidden rounded-[2.5rem] border border-pink-200/40 bg-linear-to-r from-pink-500 via-fuchsia-500 to-rose-400 px-6 py-12 text-white shadow-[0_20px_60px_rgba(244,114,182,0.16)] sm:px-10 lg:px-14 lg:py-16">
