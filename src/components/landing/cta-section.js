...
export default function CTASection() {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-[#0D9488]/40 bg-gradient-to-r from-[#0F766E] via-[#0D9488] to-teal-950 px-6 py-12 text-white shadow-xl sm:px-10 lg:px-14 lg:py-16 reveal-scale">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto space-y-5">
        ...
        <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/10 border border-white/20 text-white backdrop-blur-md shadow-sm">
          <Activity className="h-6 w-6 animate-pulse text-teal-200" />
        </span>

        <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3.5 py-1 text-xs font-semibold text-teal-100">
        ...
        <div className="flex flex-col gap-3.5 sm:flex-row pt-3">
          <a
            href="/auth/register"
            className="inline-flex items-center justify-center gap-2.5 rounded-2xl bg-white px-7 py-3.5 text-xs font-extrabold text-[#0F766E] shadow-md transition-all duration-200 hover:bg-teal-50 hover:scale-[1.02]"
          >
