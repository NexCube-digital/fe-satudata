...
export default function Hero({ walletConnected, setWalletConnected }) {
  ...
  return (
    <section
      id="top"
      className="relative overflow-hidden rounded-3xl border border-teal-100/80 bg-white px-6 py-6 text-slate-900 shadow-[0_20px_70px_rgba(13,148,136,0.08)] sm:px-8 lg:min-h-[calc(100vh-7.5rem)] lg:px-12 lg:py-8 flex flex-col justify-center"
    >
      ...
      <div className="relative grid h-full gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-10">
        ...
        <div className="space-y-6 reveal-left pt-20 lg:pt-24">
          <div className="inline-flex items-center gap-2 rounded-full border border-teal-200/80 bg-[#E6F4F1]/80 px-3.5 py-1 text-xs font-semibold tracking-wide text-[#0D9488] shadow-2xs">
            <Sparkles className="h-3.5 w-3.5 text-[#0D9488] animate-pulse" />
            Integrasi Official SATUSEHAT Kemenkes & Web3 Sovereign
          </div>

          <div className="space-y-3">
            <p className="text-xs font-extrabold uppercase tracking-[0.4em] text-[#0D9488]">
          ...
          <div className="flex flex-col gap-3.5 sm:flex-row">
            <a
              href="/auth/login"
              className="inline-flex items-center justify-center gap-2.5 rounded-2xl bg-gradient-to-r from-[#0D9488] to-[#0F766E] px-7 py-3.5 text-sm font-extrabold text-white shadow-lg shadow-teal-900/25 transition-all duration-200 hover:scale-[1.02] hover:shadow-xl hover:shadow-teal-900/30"
            >
              Mulai Sekarang
