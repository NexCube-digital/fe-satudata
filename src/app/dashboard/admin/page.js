      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-slate-800">Berjalan</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-slate-800">Administrator</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
            <h2 className="text-xl font-bold text-slate-800 mb-4">Fitur Administrator</h2>
            <ul className="space-y-3 text-slate-600">
              <li className="flex items-center gap-3">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 text-blue-600 text-sm font-bold">✓</span>
                Kelola pengguna sistem
              </li>
              <li className="flex items-center gap-3">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 text-blue-600 text-sm font-bold">✓</span>
                Monitor akses dan aktivitas
              </li>
              <li className="flex items-center gap-3">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 text-blue-600 text-sm font-bold">✓</span>
          ...
          <div className="bg-linear-to-br from-blue-50 to-cyan-50 rounded-xl border border-blue-200 p-8">
            <h2 className="text-xl font-bold text-slate-800 mb-4">Informasi Penting</h2>
            <p className="text-slate-700 mb-4">
              Dashboard Admin Anda sedang dalam pengembangan. Fitur-fitur manajemen lengkap akan segera tersedia untuk memberikan kontrol penuh atas sistem SatuData.
            </p>
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition font-medium text-sm"
            >
