    ...
    <div className="flex h-screen bg-slate-50 text-slate-800 font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-slate-50/50 space-y-6">
          {message.text && (
            <div className={`flex items-start gap-2.5 p-3.5 rounded-xl border text-xs font-semibold bg-secondary-tint border-teal-200 text-primary`}>
              ...
              <div className="lg:col-span-5 bg-white border border-slate-200/85 rounded-3xl p-6 shadow-xs space-y-5">
                    ...
                    <button
                      ...
                      className={`py-2.5 px-3 rounded-xl border text-center font-bold transition cursor-pointer text-[11px] ${
                        entryType === "registered"
                          ? "border-teal-500 bg-secondary-tint text-primary"
                ...
                {entryType === "registered" ? (
                  <div className="space-y-1.5 text-xs">
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-slate-200 px-3 py-2.5 font-semibold text-slate-800 focus:border-primary focus:outline-hidden bg-white text-xs cursor-pointer"
                    >
                  ...
                  <>
                    <div className="space-y-1.5 text-xs">
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-slate-200 px-3 py-2.5 focus:border-primary focus:outline-hidden text-xs"
                      />
                    </div>
                    <div className="space-y-1.5 text-xs">
                      <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400 block">
                      ...
                      <textarea
                        ...
                        className="w-full rounded-xl border border-slate-200 p-3 focus:border-primary focus:outline-hidden text-xs"
                      />
                    </div>
                      ...
                      <div className="pt-2 border-t border-slate-100 space-y-3">
                        <label className="flex items-center gap-2 cursor-pointer py-1.5 select-none">
                          <input
                            ...
                            className="rounded border-slate-300 text-primary focus:ring-teal-500 h-4 w-4"
                          />
                        ...
                        {createAccount && (
                          <div className="space-y-3.5 pl-4 border-l-2 border-teal-200 animate-in fade-in duration-200">
                            <div className="space-y-1.5 text-xs">
                              <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400 block">
                                Email Akun Faskes *
                              </label>
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      placeholder="-6.2088"
                      className="w-full rounded-xl border border-slate-200 px-3 py-2.5 font-mono focus:border-primary focus:outline-hidden text-xs"
                    />
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400 block">
                ...
                <div className="pt-4 border-t border-slate-100 flex gap-2">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="flex-1 py-2.5 rounded-xl bg-primary hover:bg-primary-hover text-white font-bold text-xs transition flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                  >
                    {submitting ? (
