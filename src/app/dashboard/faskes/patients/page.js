          ...
          <div className="relative overflow-hidden rounded-2xl border border-teal-500/30 bg-gradient-to-r from-teal-800 via-teal-700 to-emerald-800 px-5 py-4 text-white shadow-md mb-6">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xs text-teal-100/90 mt-1 max-w-2xl leading-relaxed">
                Kelola data pasien terotorisasi. Tinjau EHR, dekripsi secara aman dengan tanda tangan digital blockchain pasien.
              </p>
            </div>
          </div>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full rounded-lg border border-slate-200 px-3 py-1.5 bg-white text-xs focus:border-primary focus:outline-hidden"
                        />
                      </div>
                      <div>
