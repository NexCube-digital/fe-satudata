        ...
        <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
          ...
          <div className="grid gap-8 lg:grid-cols-3 items-start">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {/* Notice for Staff RS with limited permissions */}
              {isStaff && !hasPermission("access_request:create") && !hasPermission("access_request:read") && !hasPermission("medical_record:read") && !hasPermission("medical_record:upload") && (
                <div className="rounded-3xl bg-white border border-slate-200/80 p-8 text-center shadow-xs">
                  ...
                  <p className="text-xs text-slate-500 mt-1 max-w-md mx-auto">
                    Role staf Anda ({user?.staff_profile?.role_name || "Staf RS"}) tidak diberikan izin untuk modul pengajuan rekam medis dan dekripsi. Silakan gunakan menu sidebar sebelah kiri atau hubungi Admin RS jika memerlukan wewenang tambahan.
                  </p>
                </div>
              )}
            </div>
