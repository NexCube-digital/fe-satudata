    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-3xl border border-slate-200 p-8 shadow-xl space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/auth/login" className="inline-flex items-center gap-1 text-xs font-bold text-slate-500 hover:text-teal-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {message && (
            <div className="flex items-start gap-2.5 rounded-xl bg-emerald-50 border border-emerald-200 p-4 text-xs text-[#16A34A] font-medium leading-relaxed">
              <CheckCircle2 className="h-5 w-5 shrink-0 text-[#16A34A] mt-0.5" />
              <span>{message}</span>
            </div>
          )}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 rounded-xl border border-slate-300 focus:border-teal-600 focus:ring-2 focus:ring-teal-600/20 outline-none transition text-xs"
                required
                disabled={loading}
              />
            </div>
      ...
      {showUnregisteredModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md animate-in fade-in duration-300">
          <div className="relative w-full max-w-sm bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden p-6 text-center animate-in zoom-in-95 duration-200">
            ...
            {/* Warning Circle */}
            <div className="relative mx-auto h-16 w-16 rounded-full bg-red-50 text-[#DC2626] flex items-center justify-center mb-4 border border-red-100 animate-bounce">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-teal-700 to-cyan-800 hover:from-teal-800 hover:to-cyan-900 text-white font-extrabold py-3.5 rounded-2xl transition cursor-pointer shadow-md hover:shadow-lg text-xs"
            >
