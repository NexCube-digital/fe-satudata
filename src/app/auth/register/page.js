    ...
    <div className="min-h-screen lg:h-screen w-full lg:overflow-hidden flex flex-col lg:flex-row bg-slate-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 h-full relative p-12 flex-col justify-between overflow-hidden text-white shrink-0">
        ...
        <div className="relative z-10 space-y-6">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/10 px-3.5 py-1 text-xs font-semibold text-teal-100 backdrop-blur-md mb-4">
            ...
            <div className="flex-1 lg:min-h-0 flex flex-col justify-between rounded-3xl border border-slate-200/90 shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 bg-white">
              ...
              <div className="bg-slate-50 px-8 py-8 border-t border-slate-200 flex flex-col flex-1 justify-between space-y-6">
                ...
                <div className="text-center text-xs text-slate-500 font-medium pt-4 border-t border-slate-200">
                  ...
                  <Link 
                    href="/auth/login" 
                    className="text-primary hover:text-primary-hover font-bold transition hover:underline"
                  >
                    Login di sini
                  </Link>
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md animate-in fade-in duration-300">
          <div className="relative w-full max-w-2xl bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-200">
            ...
            <div className="relative z-10 shrink-0 p-6 border-b border-slate-100 flex items-center gap-3 bg-white">
              <div className="h-10 w-10 rounded-xl bg-secondary-tint text-primary flex items-center justify-center shadow-xs">
            ...
            <div className="relative z-10 shrink-0 p-5 border-t border-slate-100 bg-slate-50/60 flex items-center justify-between gap-4">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-primary to-primary-hover hover:from-primary-hover hover:to-primary text-white font-extrabold text-xs transition cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg flex items-center gap-1.5"
              >
